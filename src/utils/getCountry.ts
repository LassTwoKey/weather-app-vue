...
export function getCountryByCode(countryCode: string) {
  return countryCodes[countryCode] || 'Страна не найдена'
}

// Взял отсюда https://www.artlebedev.ru/country-list/
/*
    Код для парсинга странички:
    
    const trs = document.querySelector('.als-sortable-table tbody').children
    let countryCodes = {}
    for (let tr of trs) {
        countryCodes[tr.cells?.[3].innerText] = tr.cells?.[2].innerText // 0 - получить рус. названия, 2 - получить агл. названия
    }
    console.log(countryCodes)
*/

// Доп. Убрать кавычки у свойств - https://intellij-support.jetbrains.com/hc/en-us/community/posts/360000810240-Replace-quotes-around-JavaScript-object-properties
